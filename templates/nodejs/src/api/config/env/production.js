...
module.exports = {
   ...
   **************************************************************************/
  // ssl: {
  //   key: require('fs').readFileSync(require('path').resolve(__dirname, './ssl/unicorn.com.key')),
  //   cert: require('fs').readFileSync(require('path').resolve(__dirname, './ssl/unicorn.com.crt')),
  // },
